...
With Metro running, open a new terminal window or pane from the root of your React Native project and use the following commands to run your app on iOS:
...
If everything is set up correctly, you should see your new app running in the iOS Simulator or on your connected device.
...
To build this project with [EAS Build](https://docs.expo.dev/build/introduction/), use the provided GitHub workflow. The workflow triggers `eas build` for iOS using the credentials stored in your repository secrets.
